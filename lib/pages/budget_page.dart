...
class _BudgetPageState extends State<BudgetPage> {
  ...
  final List<Map<String, dynamic>> _budgets = [
    {"category": "Ăn uống", "limit": 1000.0, "spent": 650.0, "icon": Icons.restaurant},
    {"category": "Mua sắm", "limit": 1500.0, "spent": 1200.0, "icon": Icons.shopping_bag},
    {"category": "Đi lại", "limit": 500.0, "spent": 200.0, "icon": Icons.directions_car},
    {"category": "Giải trí", "limit": 800.0, "spent": 400.0, "icon": Icons.movie},
  ];
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Card(
              ...
              child: Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text("Tổng quan tháng này",
                        style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                    const SizedBox(height: 8),
                    Text("Hạn mức: ${totalLimit.toStringAsFixed(0)} đ"),
                    Text("Đã chi: ${totalSpent.toStringAsFixed(0)} đ"),
                    Text("Còn lại: ${(totalLimit - totalSpent).toStringAsFixed(0)} đ",
                        style: TextStyle(
                          fontWeight: FontWeight.bold,
                          color: (totalLimit - totalSpent) < 0 ? Colors.red : Colors.green,
                        )),
                  ],
                ),
              ),
            ...
            const Text("Ngân sách theo hạng mục",
                style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      leading: CircleAvatar(
                        backgroundColor: overLimit ? Colors.red[100] : Colors.blue[100],
